...
import { calculateLineItemTotal } from "@bu/invoice/calculate";
    ...
    <div className="space-y-4">
      ...
      >
        <LabelInput
          ...
          onSave={(value) => {
            setValue("template.description_label", value);
          }}
          className="truncate"
        />
        ...
        <LabelInput
          name="quantity_label"
          onSave={(value) => {
            setValue("template.quantity_label", value);
          }}
          className="truncate"
        />
        ...
        <LabelInput
          name="price_label"
          onSave={(value) => {
            setValue("template.price_label", value);
          }}
          className="truncate"
        />
        ...
        <LabelInput
          name="total_label"
          onSave={(value) => {
            setValue("template.total_label", value);
          }}
