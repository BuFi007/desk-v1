...
import { calculateTotal } from "@bu/invoice/calculate";
    ...
    <div className="w-[320px] flex flex-col">
      <div className="flex justify-between items-center py-1">
        <LabelInput
          ...
          name="subtotal_label"
          onSave={(value) => {
            setValue("template.subtotal_label", value);
          }}
        />
      ...
      {includeDiscount && (
        <div className="flex justify-between items-center py-1">
          <LabelInput
            name="discount_label"
            onSave={(value) => {
              setValue("template.discount_label", value);
            }}
          />
        ...
        <div className="flex justify-between items-center py-1">
          <div className="flex items-center gap-1">
            <LabelInput
              ...
              name="vat_label"
              onSave={(value) => {
                setValue("template.vat_label", value);
              }}
            />
        ...
        <div className="flex justify-between items-center py-1">
          <div className="flex items-center gap-1">
            <LabelInput
              ...
              name="tax_label"
              onSave={(value) => {
                setValue("template.tax_label", value);
              }}
            />
      ...
      <div className="flex justify-between items-center py-4 mt-2 border-t border-border">
        <LabelInput
          ...
          onSave={(value) => {
            setValue("template.total_summary_label", value);
          }}
        />
