...
export const WelcomeEmail = ({ fullName = "Viktor Hofte" }: Props) => {
  ...
  const text = `Hi ${firstName}, Welcome to bu! I'm Pontus, one of the founders. It's really important to us that you have a great experience ramping up.`;
        ...
        <Body className="bg-[#fff] my-auto mx-auto font-sans">
          ...
          >
            ...
            <Text className="text-[#121212]">
              Welcome to Bu! I'm Pontus, one of the founders.
              <br />
              <br />
              We've been working on Bu for the past months, and during this
              ...
              <Link
                href="https://cal.com/pontus-Bu/15min"
