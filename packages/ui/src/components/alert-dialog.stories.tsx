...
const meta: Meta<typeof AlertDialog> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          "An alert dialog component for important user confirmations.",
      },
    },
  },
};
              ...
              <AlertDialogHeader>
                ...
                <AlertDialogDescription className="max-h-[60vh] overflow-auto">
                  <div className="space-y-4 text-left">
                    ...
                    <p>
                      1. By using our service, you agree to these terms and
                      conditions.
                    </p>
                    ...
                    <p>
                      4. You are responsible for maintaining the security of
                      your account.
                    </p>
                  </div>
                </AlertDialogDescription>
