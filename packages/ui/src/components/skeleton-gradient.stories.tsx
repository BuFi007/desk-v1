...
const meta: Meta<typeof SkeletonGradient> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: "An animated gradient skeleton loader with customizable appearance.",
      },
    },
  },
};
...
export const AllVariants: Story = {
  ...
  render: () => (
    <div className="flex flex-col gap-8 p-6">
      ...
      <section>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="w-full h-48 flex flex-col items-center justify-center">
            <div className="mb-2"><Loader2 className="h-6 w-6 text-gray-500" /></div>
          ...
          <div className="w-full h-48 flex flex-col items-center justify-center">
            <div className="mb-2"><Server className="h-6 w-6 text-gray-500" /></div>
          ...
          <div className="w-full h-48 flex flex-col items-center justify-center">
            <div className="mb-2"><Database className="h-6 w-6 text-gray-500" /></div>
          ...
          <div className="w-full h-48 flex flex-col items-center justify-center">
            <div className="mb-2"><BarChart className="h-6 w-6 text-gray-500" /></div>
      ...
      <section>
        <h3 className="text-lg font-semibold mb-4">Custom Gradient Possibilities</h3>
        <div className="flex flex-wrap gap-4 justify-center">
          <div className="w-48 h-48">
            <SkeletonGradient 
              className="bg-gradient-to-br from-green-300 via-yellow-300 to-pink-300" 
            />
          </div>
          <div className="w-48 h-48">
            <SkeletonGradient 
              className="bg-gradient-to-br from-purple-300 via-red-300 to-orange-300" 
            />
          </div>
          <div className="w-48 h-48">
            <SkeletonGradient 
              className="bg-gradient-to-br from-indigo-300 via-cyan-300 to-emerald-300" 
            />
          </div>
        </div>
      </section>
